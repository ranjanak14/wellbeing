            ...
            <table class="menu-container" border="0">
                <tr>
                    ...
                    <table border="0" class="profile-container">
                                <td width="30%" style="padding-left:20px" >
                                    <img src="../Logos/logoc.png" alt="" width="100%" style="border-radius:50%">
                                </td>
                    </table>
                        <table border="0" class="profile-container">
                            <tr>
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-appoinment">
                        <a href="appointment.php" class="non-style-link-menu"><div><p class="menu-text">Appointment Bookings</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <p>Taking Care of Your health should be first priority! </a><br>
                                Find a Variety of Helpful Tools to take best care of yourself. Find  helpful programs encompassing physical and emotional well being care.<br>Feel free to browse around and explore our variety of well being support apps<br><br> You can also book Appointments with Real Doctors through our platform if needed anytime.
                            </p>
                            
                            <h3>Search a Doctor Here</h3>
                            <form action="schedule.php" method="post" style="display: flex">

                                <input type="search" name="search" class="input-text " placeholder="Enter a Doctor Name" list="doctors" style="width:45%;">&nbsp;&nbsp;
